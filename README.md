...
Результаты работы программы представлены в файле result.txt

Проект собирается с помощью Gradle и Shadow.

Запуск производится командой java -jar -Xmx1G interview.jar <Название входного файла>